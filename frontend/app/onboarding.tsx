...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", minHeight: 56, paddingHorizontal: spacing.lg, paddingBottom: spacing.sm },
  stepCounter: { color: colors.onSurfaceSecondary, fontSize: 16, lineHeight: 22, fontWeight: "700" },
  skip: { color: colors.brandPrimary, fontSize: 16, lineHeight: 22, fontWeight: "800" },
  progressBg: { height: 8, backgroundColor: colors.surfaceTertiary, marginHorizontal: spacing.lg, borderRadius: radius.pill, overflow: "hidden" },
  progressFill: { height: 8, backgroundColor: colors.brandPrimary, borderRadius: radius.pill },
  scroll: { width: "100%", maxWidth: 680, alignSelf: "center", paddingHorizontal: spacing.lg, paddingTop: spacing.xl, paddingBottom: spacing.xl },
  question: { fontSize: 30, fontWeight: "800", color: colors.onSurface, lineHeight: 38 },
  helper: { fontSize: 18, color: colors.onSurfaceSecondary, lineHeight: 27, marginTop: spacing.sm },
  textInput: { backgroundColor: colors.surfaceSecondary, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border, padding: 18, color: colors.onSurface, fontSize: 18, lineHeight: 24, minHeight: 60 },
  optionsCol: { gap: spacing.sm },
  optionRow: { flexDirection: "row", alignItems: "center", gap: spacing.md, backgroundColor: colors.surface, padding: spacing.md, borderRadius: radius.md, borderWidth: 2, borderColor: colors.border, minHeight: 68 },
  optionRowActive: { borderColor: colors.brandPrimary, backgroundColor: colors.brandTertiary },
  optionEmoji: { fontSize: 28 },
  optionLabel: { flex: 1, fontSize: 18, lineHeight: 24, fontWeight: "700", color: colors.onSurface },
  optionLabelActive: { color: colors.onBrandTertiary, fontWeight: "800" },
  optionsGrid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm },
  chip: { maxWidth: "100%", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, backgroundColor: colors.surface, paddingHorizontal: spacing.md, paddingVertical: 10, borderRadius: radius.pill, borderWidth: 2, borderColor: colors.border },
  chipActive: { borderColor: colors.brandPrimary, backgroundColor: colors.brandTertiary },
  chipEmoji: { fontSize: 18 },
  chipText: { flexShrink: 1, fontSize: 16, lineHeight: 22, fontWeight: "700", color: colors.onSurface },
  chipTextActive: { color: colors.onBrandTertiary, fontWeight: "800" },
  footer: { padding: spacing.lg, backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.border, shadowColor: colors.onSurface, shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: -4 }, elevation: 5 },
  saveError: { color: colors.error, fontSize: 16, lineHeight: 23, marginBottom: spacing.sm, textAlign: "center" },
  continueBtn: { backgroundColor: colors.brandPrimary, padding: spacing.md, borderRadius: radius.md, alignItems: "center", minHeight: 60, justifyContent: "center" },
  continueBtnDisabled: { opacity: 0.4 },
  continueText: { color: colors.onBrandPrimary, fontSize: 18, lineHeight: 24, fontWeight: "800" },
  modalBackdrop: { flex: 1, justifyContent: "center", padding: spacing.lg, backgroundColor: "rgba(36, 54, 47, 0.48)" },
  modalPanel: { width: "100%", maxWidth: 460, alignSelf: "center", backgroundColor: colors.surface, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border, padding: spacing.lg },
  modalTitle: { color: colors.onSurface, fontSize: 22, lineHeight: 29, fontWeight: "800" },
  modalHelper: { color: colors.onSurfaceSecondary, fontSize: 16, lineHeight: 23, marginTop: spacing.xs },
  modalInput: { minHeight: 120, maxHeight: 180, marginTop: spacing.md, padding: spacing.md, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surfaceSecondary, color: colors.onSurface, fontSize: 18, lineHeight: 25, textAlignVertical: "top" },
  modalActions: { flexDirection: "row", justifyContent: "flex-end", gap: spacing.sm, marginTop: spacing.lg },
  modalCancel: { minHeight: 48, minWidth: 96, alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.md, borderRadius: radius.md, borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: colors.surface },
  modalCancelText: { color: colors.onSurface, fontSize: 16, lineHeight: 22, fontWeight: "800" },
  modalSave: { minHeight: 48, minWidth: 96, alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.md, borderRadius: radius.md, backgroundColor: colors.brandPrimary },
  modalSaveDisabled: { opacity: 0.4 },
  modalSaveText: { color: colors.onBrandPrimary, fontSize: 16, lineHeight: 22, fontWeight: "800" },
});
