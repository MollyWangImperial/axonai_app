...
import { authedFetch, deleteAccount, getCachedUser, preferredNameKey, signOut } from "@/src/auth";
        ...
        <View style={styles.inner}>
          ...
          {section === "account" ? (
            <>
              ...
              <Pressable testID="account-delete" onPress={() => setShowDeleteModal(true)} style={[styles.dangerButton, { marginTop: spacing.sm }]}><Ionicons name="trash-outline" size={20} color={colors.error} /><Text style={styles.dangerText}>Delete account</Text></Pressable>
              <Text style={[styles.lead, { color: palette.muted, marginTop: spacing.xs }]}>Deleting removes your profile and assessments from Rehyn.</Text>
            </>
          ) : null}
...
const styles = StyleSheet.create({
  ...
  deleteBackdrop: { flex: 1, alignItems: "center", justifyContent: "center", padding: spacing.lg, backgroundColor: "rgba(10,22,16,0.6)" },
  deleteCard: { width: "100%", maxWidth: 440, borderRadius: radius.md, padding: spacing.lg },
  deleteTitle: { fontSize: 20, lineHeight: 26, fontWeight: "800" },
  ...
  deleteCancel: { minHeight: 46, minWidth: 96, alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.md, borderRadius: radius.pill, borderWidth: 1 },
  deleteCancelText: { fontSize: 15, fontWeight: "700" },
  deleteConfirm: { minHeight: 46, minWidth: 110, alignItems: "center", justifyContent: "center", paddingHorizontal: spacing.md, borderRadius: radius.pill, backgroundColor: colors.error },
