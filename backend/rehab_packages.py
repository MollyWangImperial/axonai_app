...
LOWER_LIMB_TASKS_DATA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "view": "Front view",
        "focus": "Patient-reported mobility with an uploaded frontal walking record",
        "safety_tier": "spotter_required",
        ...
        "steps": [
            {
                ...
                "caption": "Upload a short frontal walking video",
            ...
            {
                "id": "L6-S2",
                "voice": "Walk toward the camera at your usual comfortable pace for a few natural steps. Do not walk faster or farther than feels safe.",
                "target": {"x": 0.78, "y": 0.78, "r": 0.17, "landmark": "WALK_ACROSS"},
                "hold_ms": 900,
                "caption": "Walk naturally toward the camera",
                "measure": [],
            ...
            {
                "id": "L6-S3",
                "voice": "Stop in a safe position. The short frontal walking video is ready to upload.",
