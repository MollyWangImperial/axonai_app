...
LOWER_LIMB_TASKS_DATA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "filming_guidance": [
            ...
            "The caregiver must not walk backward, cross the patient's path, or film while also providing hands-on support. Use a separate person for guarding when required.",
            "Keep the phone steady at about waist or chest height, avoid zooming, and continue filming until the patient has stopped safely.",
        ],
        "steps": [
            {
                "id": "L6-S1",
                ...
                "caption": "Carer: keep the patient's whole body visible from the side",
            ...
            {
                "id": "L6-S2",
                "voice": "Now walk at your usual comfortable pace and take several natural steps. Carer, keep the phone steady and keep the patient's whole body in view. Stay fixed if the path fits, or move smoothly parallel to the patient if needed. Do not zoom or walk backward. Patient, do not walk faster or farther than feels safe.",
                "target": {"x": 0.78, "y": 0.78, "r": 0.17, "landmark": "WALK_ACROSS"},
                "hold_ms": 900,
                "caption": "Walk naturally while the carer keeps your full body visible",
            ...
            {
                "id": "L6-S3",
                "voice": "Stop in a safe position and stand still with your usual support for a moment. Carer, keep the patient's head and feet visible until the stop is complete.",
